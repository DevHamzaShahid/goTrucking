    ...
    <Block>
      ...
      <View
        ...
        <Card
          ...
          hours={delayHours}
          mins={delayMins}
          openDelayModal={setChooseDelayTime}
          requireButtonType={
            param?.requireButtonType ? param?.requireButtonType : 'none'
          }
        ...
        {successErrorAlert && (
          <CustomAlert
            ...
            alertType={'error'}
            Title={'SORRY! IT’S 5AM'}
            description={'You cannot start working until 7am.'}
            buttonText={'OK'}
          />
        )}
      </View>
