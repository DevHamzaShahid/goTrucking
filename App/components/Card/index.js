                ...
                data?.map(() => (
                    <View style={{ width: '95%', backgroundColor: color.white, alignSelf: 'center', borderRadius: 4, marginVertical: 10 }}>
                        ...
                        <View style={{ flexDirection: 'row', width: '100%', }}>
                            {/* avatar */}
                            <View style={{ width: '23%', height: 70, alignItems: 'center', justifyContent: 'center', borderRadius: 4 }}>
                                <View style={{ height: 50, width: 50, backgroundColor: color.appBlue, borderRadius: 30, alignItems: 'center', justifyContent: 'center' }}>
                                    <Location />
                                </View>
                            </View>
                            {/* id container*/}
                            <View style={{ width: '45%', height: 70, alignItems: 'flex-start', justifyContent: 'center' }}>
                                <CustomText size={16} style={{ color: color.textGrey, fontWeight: '500', marginVertical: 1 }}>
                                    Pickup Point 1
                                </CustomText>
                                <CustomText size={14} style={{ color: color.appBlue, fontWeight: '600' }}>
                                    ID : 8837373828
                                </CustomText>
                            </View>
                            {/* navigate button */}
                            <TouchableOpacity style={{ width: '32%', height: 70, alignItems: 'center', justifyContent: 'center', borderRadius: 4, }}>
                                <View style={{ backgroundColor: color.appBlue, width: '90%', height: 30, borderRadius: 6, flexDirection: 'row', justifyContent: 'space-evenly', alignItems: 'center' }}>
                        ...
                        <View style={{ width: '100%', height: 50, alignSelf: 'center', flexDirection: 'row' }}>
                            <View style={{ width: '33%', alignItems: 'flex-start', justifyContent: 'center', paddingLeft: 10 }}>
                                <CustomText size={12} style={{ color: color.textGrey, fontWeight: '500' }}>
                                    Time
                                </CustomText>
                                <CustomText size={13} style={{ color: color.appBlue, fontWeight: '600' }}>
                                    7am - 8:30am
                                </CustomText>
                            </View>
                            <View style={{ width: '33%', alignItems: 'flex-start', justifyContent: 'center', paddingLeft: 10 }}>
                        ...
                        <View style={{ height: 50, width: '95%', alignSelf: 'center', justifyContent: 'center', marginVertical: 10 }}>
                            <CustomText size={14} style={{ color: color.textGrey, fontWeight: '500', marginVertical: 2 }}>
                                Special Instructions :
                            </CustomText>
                            <CustomText size={14} style={{ color: color.appBlue, fontWeight: '500' }}>
                                Handle with care
                            </CustomText>
                        </View>
